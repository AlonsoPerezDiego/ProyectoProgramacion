...
public class MetodosUsuario {
    public static void mostrarDatosJugador(){
        try {
            ...
            ResultSet rs=stmt.executeQuery("select * from jugador where numxogador="+NewGame.codPartidaLabel.getText()+";");
            NewGame.nombreLabel.setText(rs.getString("njugador"));
            NewGame.victoriasLabel.setText("Nº de victorias: "+rs.getInt("pwin"));
            NewGame.derrotasLabel.setText("Nª de derrota: "+rs.getInt("plose"));
            ...
            System.err.println("Fallo al cargar jugador");
        }
    }
    public static void borrarJugador(){
        try {
            ...
            try {
                ...
                System.err.println("Error al insertar jugador vacio");;
            }
        }
    }
}
